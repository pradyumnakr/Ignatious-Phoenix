...
wf = wildfire()
video_cnt = 10
wf.generate_dataset(1,20,video_cnt,'dalma_400240.mp4')
tot_video_cnt += video_cnt

video_cnt = 30
wf.generate_dataset(1,80,video_cnt,'gwanak_400240.mp4')
tot_video_cnt += video_cnt
...
video_cnt1 = 10
wf.test_dataset(1,20,video_cnt1,'nofire_400240.mp4')
